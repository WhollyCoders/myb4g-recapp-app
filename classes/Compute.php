...
class Compute{
  ...
  public function weight_loss_overall(){
    return number_format($this->begin - $this->current, 1);
  }
  public function weight_loss_percent_overall(){
  ...
  public function compile_results(){
    ...
    $this->results['overall_weight_loss']         = $this->weight_loss_overall();
    $this->results['overall_weight_loss_percent'] = $this->weight_loss_percent_overall();
  }
